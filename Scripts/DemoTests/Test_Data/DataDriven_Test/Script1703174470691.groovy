...
WebUI.click(findTestObject('Object Repository/Page_Orders  nopCommerce administration/a_Wait_nopSideBarPusher'))

WebUI.click(findTestObject('Object Repository/Page_Orders  nopCommerce administration/p_Dashboard'))
